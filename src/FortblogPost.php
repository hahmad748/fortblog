 ...
 * @property-read FortblogAuthor $author
 * @property-read Collection<FortblogTag> $tags
 */
class FortblogPost extends AbstractFortblogModel
{
    /**
     ...
     * @var string
     */
    protected $table = 'fortblog_posts';
    ...
    {
        return $this->belongsToMany(FortblogTag::class, 'fortblog_posts_tags', 'post_id', 'tag_id');
    }
    ...
    {
        return $this->belongsTo(FortblogAuthor::class, 'author_id');
    }
