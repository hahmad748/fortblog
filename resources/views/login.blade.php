...
<div class="container mt-20">
    <div class="xl:w-1/2 mx-auto">
        ...
        <form method="POST" action="{{route('fortblog.auth.attempt')}}">
            @csrf
            ...
            <div class="flex items-center mb-10">
                ...
                <a href="{{route('fortblog.password.forgot')}}" class="no-underline text-primary">Forgot your password?</a>
            </div>
