    ...
    export default {
        ...
        methods: {
            getImagesFromUnsplash(page = 1) {
                ...
                axios.get('https://api.unsplash.com/search/photos?client_id=' + Fortblog.unsplash_key +
...
<template>
    <div>
        ...
        <div class="mb-0">
            ...
            <span v-if="Fortblog.unsplash_key">or</span>
            <a v-if="Fortblog.unsplash_key" href="#" @click.prevent="openUnsplashModal" class="text-text-color">search Unsplash</a>
        </div>
