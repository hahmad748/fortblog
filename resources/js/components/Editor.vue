<script type="text/ecmascript">
    ...
    import FortblogImageBlot from './editorComponents/FortblogImageBlot.js';
    import FortblogDividerBlot from './editorComponents/FortblogDividerBlot.js';
    import HTMLBlot from './editorComponents/HTMLBlot.js';
    import FortblogClipboard from './editorComponents/FortblogClipboard.js';
    import FortblogLink from './editorComponents/FortblogLink.js';
    ...
    export default {
        ...
        methods: {
            ...
            createEditor() {
                ...
                Quill.register(FortblogImageBlot, true);
                Quill.register(FortblogDividerBlot, true);
                Quill.register(HTMLBlot, true);
                Quill.register(FortblogLink, true);
                Quill.register('modules/clipboard', FortblogClipboard, true)
...
//                        [{'direction': 'rtl'}],
            ...
            handleClicksInsideEditor() {
                this.editor.root.addEventListener('click', (ev) => {
                    ...
                    if (blot instanceof FortblogImageBlot) {
