                ...
                <div class="flex items-center mr-auto h-8">
                    <h3 class="mr-5 font-semibold font-serif" :class="{'hidden': hideLogoOnSmallScreens, 'sm:block': hideLogoOnSmallScreens}">
                        <router-link to="/" class="no-underline text-text-color">
                            <span class="text-light">Devs</span>Fort.
                        </router-link>
                    </h3>
                ...
                <div class="flex items-center">
                    ...
                    <dropdown class="relative ml-6">
                        <button slot="trigger" type="button" class="focus:outline-none">
                            <img :src="Fortblog.author.avatar" class="rounded-full w-8 h-8" :title="Fortblog.author.name">
                        </button>

                        <div slot="content" class="dropdown-content pin-r min-w-dropdown mt-1 text-sm py-2">
                            <router-link :to="{name:'team-edit', params:{id: Fortblog.author.id}}" class="no-underline text-text-color font-sans hover:text-primary w-full block py-2 px-4 border-b border-very-light">
                                Profile
                            </router-link>
                            ...
                            <a :href="'/'+Fortblog.path+'/logout'" class="no-underline text-text-color hover:text-primary w-full block py-2 px-4 border-t border-very-light">
                                Log out
                            </a>
                        </div>
                    </dropdown>
