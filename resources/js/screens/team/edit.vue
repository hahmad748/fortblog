<script type="text/ecmascript">
    ...
    export default {
         ...
         */
        mounted() {
            document.title = "Author — Devsfort.";
        ...
        methods: {
            ...
            save() {
                ...
                this.http().post('/api/team/' + this.id, this.form).then(response => {
                    ...
                    if(this.Fortblog.author.id == this.entry.id && (this.theme != this.form.meta.theme || this.avatar != this.form.avatar)) {
                        location.reload();
                    }
                }).catch(error => {
    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="lg:w-2/3 mx-auto" v-if="ready && entry">
                <h1 class="font-semibold text-3xl mb-10" v-if="id != 'new' && Fortblog.author.id != entry.id">Edit Author</h1>
                <h1 class="font-semibold text-3xl mb-10" v-if="id == 'new' && Fortblog.author.id != entry.id">New Author</h1>
                <h1 class="font-semibold text-3xl mb-10" v-if="Fortblog.author.id == entry.id">Your Profile</h1>
