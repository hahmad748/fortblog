<script type="text/ecmascript">
    ...
    export default {
        ...
        data() {
            return {
                ...
                form: {
                    ...
                    body: '',
                    published: false,
                    markdown: ({null: null, 'markdown' : true, 'rich': false})[window.Fortblog.default_editor],
                    publish_date: '',
                    meta: {
                        meta_description: '',
                        opengraph_title: '',
         ...
         */
        mounted() {
            document.title = "Edit Post — Devsfort.";
        ...
        computed: {
            postPreviewLink() {
                return this.Fortblog.preview_path.replace('{postSlug}', this.form.slug);
            }
        },
            ...
            loadResources() {
                ...
                this.http().get('/api/team').then(response => {
                    ...
                    if (!this.form.author_id && this.authors) {
                        this.form.author_id = this.Fortblog.author.id;
                    }
                });
            },
